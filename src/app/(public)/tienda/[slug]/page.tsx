      ...
      <main style={{ background: 'var(--background)' }}>
        <div className="px-6 md:px-16 max-w-5xl mx-auto py-20 md:py-28">
          ...
          {productosGrid.length > 0 && (
            <TodosClient productos={productosGrid} nombreCategoria={meta.nombre} mostrarPrecios={mostrarPrecios} estaLogueado={!!user} esMayorista={esMayorista} precioIncluyeIva={listaPrecio === 'precio_lista5'} />
          )}
        </div>
      </main>
    )
  ...
  return (
    <main style={{ background: 'var(--background)' }}>
      <div className="px-6 md:px-16 max-w-5xl mx-auto py-20 md:py-28">
        ...
        <div className="mb-6" />
        <TodosClient productos={productosGrid} nombreCategoria={categoriaHome.nombre} mostrarPrecios={mostrarPrecios} estaLogueado={!!user} esMayorista={esMayorista} precioIncluyeIva={listaPrecio === 'precio_lista5'} />
      </div>
    </main>
  )
}
